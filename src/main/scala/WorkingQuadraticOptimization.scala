...
object WorkingQuadraticOptimization extends App {
  ...
  inequalities(0) = new LinearMultivariateRealFunction(Array(-1.0, 0), 0)
  inequalities(1) = new LinearMultivariateRealFunction(Array(0.0, -1), 0)
